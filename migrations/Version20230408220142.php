 ...
 */
final class Version20230408220142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE price (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, seller_id INT NOT NULL, value VARCHAR(30) NOT NULL, discont_value VARCHAR(30) DEFAULT NULL, INDEX IDX_CAC822D94584665A (product_id), INDEX IDX_CAC822D98DE820D9 (seller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
